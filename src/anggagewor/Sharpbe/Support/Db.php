...
namespace anggagewor\Sharpbe\Support;
...
class Db
{
    ...
    {
        $sql_str = 'CREATE TABLE IF NOT EXISTS '.$table.' . (id BIGINT(20) NOT NULL AUTO_INCREMENT ';
